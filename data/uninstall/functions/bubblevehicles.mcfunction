say §7Uninstalling §e§lBubbleVehicles 3.2e§r§7...
...
say §c§lBubbleVehicles 3.2e §r§edatapack uninstalled §r§7§oUse /reload to reinstall the datapack, disable it or delete the file