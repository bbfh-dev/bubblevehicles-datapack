...
execute if score $Success bubblevehicles matches 1 as @e[type=!player, tag=buvs.papermc, distance=..4] run function bubblevehicles:vehicles/abstracts/player/interaction_menu/handler