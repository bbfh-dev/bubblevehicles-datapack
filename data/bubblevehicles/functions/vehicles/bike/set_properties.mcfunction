scoreboard players set @s buvs.max_speed 1600
scoreboard players set @s buvs.min_speed -300
...
scoreboard players set @s buvs.tank_mod 2250
scoreboard players set @s buvs.gears_count 3
scoreboard players set @s buvs.inventory 1
scoreboard players set @s buvs.health 90
