...
execute if score $Success bubblevehicles matches 1 as @e[type=!player, tag=bubblevehicles, distance=..4] run function bubblevehicles:vehicles/abstracts/player/interaction_menu/handler