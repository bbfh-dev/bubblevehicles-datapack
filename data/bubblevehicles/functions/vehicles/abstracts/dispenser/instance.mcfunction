...
execute as @e[type=marker, tag=buvs.origin, distance=..3, limit=1, sort=nearest] unless score @s bvehicle.fuel = @s buvs.tank_cap run function bubblevehicles:vehicles/abstracts/dispenser/action
