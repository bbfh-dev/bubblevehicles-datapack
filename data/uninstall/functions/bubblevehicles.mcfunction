say §7Uninstalling §e§lBubbleVehicles 3.3a§r§7...
...
say §c§lBubbleVehicles 3.3a §r§edatapack uninstalled §r§7§oUse /reload to reinstall the datapack, disable it or delete the file